...
<html>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(<c:url value='/resources/images/product-1.jpg' />);">
							<div class="inner">
								<p>
				...
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(<c:url value='/resources/images/product-2.jpg' />);">
				...
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(<c:url value='/resources/images/product-3.jpg' />)">
							<div class="inner">
								<p>
									<a href="single.html" class="icon"><i class="icon-shopping-cart"></i></a>
									<a href="single.html" class="icon"><i class="icon-eye"></i></a>
			...
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(<c:url value='/resources/images/product-4.jpg' />)">
							<div class="inner">
								<p>
									<a href="single.html" class="icon"><i class="icon-shopping-cart"></i></a>
									<a href="single.html" class="icon"><i class="icon-eye"></i></a>
				...
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(<c:url value='/resources/images/product-5.jpg' />)">
							<div class="inner">
								<p>
									<a href="single.html" class="icon"><i class="icon-shopping-cart"></i></a>
									<a href="single.html" class="icon"><i class="icon-eye"></i></a>
				...
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(<c:url value='/resources/images/product-6.jpg' />)">
							<div class="inner">
								<p>
									<a href="single.html" class="icon"><i class="icon-shopping-cart"></i></a>
									<a href="single.html" class="icon"><i class="icon-eye"></i></a>
						...
						<div class="owl-carousel owl-carousel-fullwidth">
							<div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="<c:url value="/resources/images/person1.jpg"/>" alt="user">
									</figure>
							...
							<div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="<c:url value="/resources/images/person2.jpg"/>" alt="user">
									</figure>
							...
							<div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="<c:url value="/resources/images/person3.jpg"/>" alt="user">
									</figure>
									<span>John Doe, via <a href="#" class="twitter">Twitter</a></span>
									<blockquote>
	...
	<div id="fh5co-counter" class="fh5co-bg fh5co-counter" style="background-image:url(<c:url value='/resources/images/img_bg_5.jpg' />)">
		<div class="container">
			<div class="row">
				<div class="display-t">
